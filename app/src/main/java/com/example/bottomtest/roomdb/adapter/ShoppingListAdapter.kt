...
class ShoppingListAdapter constructor(private val activity: Fragment, private val context: Context) : RecyclerView.Adapter<ShoppingListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        mShoppingViewModel = ShoppingListViewModel(activity.requireActivity().application)
        ...
        holder.itemView.count_delete_item.setOnClickListener {
            ...
            builder.setTitle("Delete ${currentItem.name}?")
