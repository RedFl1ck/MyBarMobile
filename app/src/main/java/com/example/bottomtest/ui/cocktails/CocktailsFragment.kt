...
class CocktailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.filterCocktailsButton.setOnClickListener {
            ...
            val bottomSheetView = LayoutInflater.from(this.requireContext()).inflate(
                R.layout.sheet_filter_cocktails,
                view.findViewById(R.id.cocktails_filter_sheet)
            )
            ...
            bottomSheetView.findViewById<Chip>(R.id.chip_1)
            ...
            bottomSheetView.findViewById<Chip>(R.id.chip_2)
                .setOnCheckedChangeListener { compoundButton: CompoundButton, isChecked: Boolean ->
                    chip2 = if (isChecked) {
                        Toast.makeText(
                            this.requireContext(),
                            "you checked filter 2",
                            Toast.LENGTH_SHORT
                        ).show()
                        true
                    } else {
            ...
            bottomSheetView.findViewById<Chip>(R.id.chip_3)
                .setOnCheckedChangeListener { compoundButton: CompoundButton, isChecked: Boolean ->
                    chip3 = isChecked
                }

            bottomSheetView.findViewById<Chip>(R.id.chip_4)
                .setOnCheckedChangeListener { compoundButton: CompoundButton, isChecked: Boolean ->
                    chip4 = isChecked
                }

            bottomSheetView.findViewById<Chip>(R.id.chip2_1)
                .setOnCheckedChangeListener { compoundButton: CompoundButton, isChecked: Boolean ->
                    chip2_1 = isChecked
                }

            bottomSheetView.findViewById<Chip>(R.id.chip2_2)
                .setOnCheckedChangeListener { compoundButton: CompoundButton, isChecked: Boolean ->
                    chip2_2 = isChecked
                }
        ...
        binding.sortCocktailsButton.setOnClickListener {
            ...
            val bottomSheetView = LayoutInflater.from(this.requireContext()).inflate(
                R.layout.sheet_sort_cocktails,
                view.findViewById(R.id.cocktails_sort_sheet)
            )
            bottomSheetDialog.setContentView(bottomSheetView)
            bottomSheetDialog.show()
